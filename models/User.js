...
const userSchema = new mongoose.Schema({
  ...
  position: {
    ...
    enum: [
      ...
      'SECRETARY', 'ASSISTANT SECRETARY', 'TREASURER', 'COORDINATOR', 'ASSISTANT COORDINATOR', 'STATE SECRETARY', 'STATE ASSISTANT SECRETARY','CHAIRMAN', 'VICE CHAIRMAN', 'ASSISTANT FINANCIAL SECRETARY'
    ],
    default: 'MEMBER'
  },
