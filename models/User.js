...
const userSchema = new mongoose.Schema({
  ...
  position: {
    ...
    enum: [
      ...
      'SECRETARY', 'ASSISTANT SECRETARY', 'TREASURER', 'COORDINATOR', 'ASSISTANT COORDINATOR', 'STATE SECRETARY', 'STATE ASSISTANT SECRETARY', 'STATE TREASURER', 'CHAIRMAN', 'VICE CHAIRMAN', 'ASSISTANT FINANCIAL SECRETARY'
    ],
    default: 'MEMBER'
  },
